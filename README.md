...
- Separation of raw, processed, and inference datasets  
...
- Parquet used for performance and schema stability  
...
- All intermediate artefacts and inference outputs saved for auditability  

---

### Signal Construction

- Model outputs class probabilities for each asset across multiple horizons  
...
- Signals constructed as:
  - Long: top x% of ranked assets  
  - Short: bottom x% of ranked assets  
- No absolute probability thresholds → reduces sensitivity to calibration drift  
...
- Identical signal construction and portfolio logic applied  
- Transformer outperforms the challenger out-of-sample after costs  

---

### Backtesting, Validation, and Testing

- Custom backtesting engine fully integrated with unit and integration tests  
...
|   ├── data/          # Ingestion and feature engineering testing
│   ├── inference/     # Model inference logic testing
│   ├── models/        # Transformer architecture testing
│   ├── models/        # Transformer architecture testing
...
- Rigorous unit and integration testing ensures backtest correctness and reproducibility  